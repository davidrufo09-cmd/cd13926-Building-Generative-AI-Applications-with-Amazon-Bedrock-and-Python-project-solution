...
module "bedrock_kb" {
  ...
  aurora_arn      = "arn:aws:rds:us-west-2:594695117986:cluster:my-aurora-serverless"
  aurora_db_name    = "myapp"
  aurora_endpoint  = "my-aurora-serverless.cluster-c2pch4muptyq.us-west-2.rds.amazonaws.com"
  ...
  aurora_secret_arn = "arn:aws:secretsmanager:us-west-2:594695117986:secret:my-aurora-serverless-UK4Eua"
  s3_bucket_arn = "arn:aws:s3:::bedrock-kb-594695117986"
}